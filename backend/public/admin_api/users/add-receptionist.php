...
try {
    ...
    // Receptionists don't need department field
    ...
    // Receptionists don't need a separate role-specific table like nurses
    // They're just in staff and user_account tables
    ...
    echo json_encode([
        'success'  => true,
        'message'  => 'Receptionist created successfully with ' . $schedulesCreated . ' work schedules',
        'staff_id' => $staffId,
        'username' => $username,
    ]);
} catch (Exception $e) {
