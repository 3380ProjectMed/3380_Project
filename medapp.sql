...
-- Dumping data for table med-app-db.Appointment: ~12 rows (approximately)
DELETE FROM `Appointment`;
INSERT INTO `Appointment` (`Appointment_id`, `Patient_id`, `Doctor_id`, `Office_id`, `Appointment_date`, `Date_created`, `Reason_for_visit`) VALUES
	(1001, 1, 1, 1, '2025-10-23 09:00:00', '2025-10-20 14:30:00', 'Annual physical examination'),
	(1002, 3, 1, 1, '2025-10-23 14:00:00', '2025-10-02 16:45:00', 'Follow-up consultation'),
	(1003, 5, 2, 1, '2024-01-15 10:30:00', '2023-12-22 09:15:00', 'Cardiology checkup'),
	(1004, 7, 2, 4, '2024-01-17 11:00:00', '2024-01-08 14:25:00', 'Heart condition monitoring'),
	(1005, 2, 3, 2, '2024-01-15 13:30:00', '2023-12-28 11:20:00', 'Pediatric wellness visit'),
	(1006, 8, 3, 2, '2024-01-18 15:45:00', '2024-01-11 12:15:00', 'Vaccination'),
	(1007, 4, 4, 3, '2024-01-16 08:45:00', '2023-12-28 11:20:00', 'Orthopedic consultation'),
	(1008, 1, 4, 1, '2024-01-19 16:00:00', '2024-01-09 17:40:00', 'Knee pain evaluation'),
	(1009, 6, 5, 4, '2024-01-17 09:30:00', '2024-01-05 08:30:00', 'OB/GYN appointment'),
	(1010, 3, 6, 2, '2024-01-18 10:00:00', '2024-01-12 09:50:00', 'Internal medicine consultation'),
	(1011, 4, 7, 4, '2024-01-19 14:30:00', '2024-01-15 16:20:00', 'Dermatology screening'),
	(1012, 4, 1, 2, '2025-10-24 09:00:00', '2025-10-20 09:00:00', 'Follow-up consultation');
...
DELETE FROM `Doctor`;
INSERT INTO `Doctor` (`Doctor_id`, `First_Name`, `Last_Name`, `SSN`, `Gender`, `Specialty`, `Work_Schedule`, `Work_Location`, `Email`, `Phone`, `License_Number`) VALUES
	(1, 'Emily', 'Chen', '123-45-6781', 2, 3, NULL, 1, 'echen@medconnect.com', '737-492-000', 'TXMD123456'),
	(2, 'James', 'Rodriguez', '123-45-6782', 1, 14, NULL, 1, 'jrodriguez@medconnect.com', '737-492-8102', 'TXMD123457'),
	(3, 'Susan', 'Lee', '123-45-6783', 2, 4, NULL, 2, 'slee@medconnect.com', '737-879-710', 'TXMD123458'),
	(4, 'Richard', 'Patel', '123-45-6784', 1, 15, NULL, 3, 'rpatel@medconnect.com', '737-879-7102', 'TXMD123459'),
	(5, 'Maria', 'Garcia', '123-45-6785', 2, 5, NULL, 4, 'mgarcia@medconnect.com', '737-492-8103', 'TXMD123460'),
	(6, 'David', 'Kim', '123-45-6786', 1, 3, NULL, 2, 'dkim@medconnect.com', '737-879-7103', 'TXMD123461'),
	(7, 'Lisa', 'Wong', '123-45-6787', 2, 13, NULL, 4, 'lwong@medconnect.com', '737-492-8104', 'TXMD123462');
...
INSERT INTO `insurance_plan` (`plan_id`, `payer_id`, `plan_name`, `plan_type`, `network_rules`) VALUES
	(101, 1, 'BCBS Gold', 'PPO', NULL),
	(102, 1, 'BCBS Silver', 'HMO', NULL),
	(103, 2, 'Aetna Premier', 'PPO', NULL),
	(104, 3, 'UHC Choice Plus', 'PPO', NULL),
	(105, 4, 'Medicare Part B', 'Medicare', NULL);
...
-- Dumping data for table med-app-db.MedicalCondition: ~11 rows (approximately)
DELETE FROM `MedicalCondition`;
INSERT INTO `MedicalCondition` (`Condition_id`, `Patient_id`, `Condition_name`, `Diagnosis_date`, `CreatedAt`, `CreatedBy`, `LastUpdated`, `UpdatedBy`) VALUES
...
-- Dumping data for table med-app-db.MedicalHistory: ~14 rows (approximately)
DELETE FROM `MedicalHistory`;
INSERT INTO `MedicalHistory` (`History_ID`, `Patient_ID`, `Condition_Name`, `Diagnosis_Date`) VALUES
...
-- Dumping data for table med-app-db.MedicationHistory: ~13 rows (approximately)
DELETE FROM `MedicationHistory`;
INSERT INTO `MedicationHistory` (`Drug_ID`, `Patient_ID`, `Drug_name`, `DurationAndFrequencyOfDrugUse`) VALUES
	(1, 1, 'Lisinopril 10mg', 'Once daily since August 2020'),
	(2, 1, 'Metformin 500mg', 'Twice daily since December 20223'),
...
DELETE FROM `Office`;
INSERT INTO `Office` (`Office_ID`, `Name`, `City`, `State`, `address`, `ZipCode`, `DeptCount`, `Phone`) VALUES
...
DELETE FROM `Patient`;
INSERT INTO `Patient` (`Patient_ID`, `First_Name`, `Last_Name`, `dob`, `SSN`, `EmergencyContact`, `AssignedAtBirth_Gender`, `Gender`, `Ethnicity`, `Race`, `Email`, `Consent_Disclose`, `Primary_Doctor`, `Specialty_Doctor`, `InsuranceID`, `InsuranceProvider`, `Prescription`, `Allergies`, `BloodType`, `PayerType`) VALUES
	(1, 'John', 'Smith', '1985-03-15', '123-45-6789', '555-1001', 1, 1, 2, 1, 'john.smith@email.com', 'Y', 1, NULL, 1, 101, NULL, NULL, 'O+', 'Private'),
	(2, 'Maria', 'Garcia', '1978-07-22', '123-45-6790', '555-1002', 2, 2, 1, 2, 'maria.garcia@email.com', 'Y', 3, NULL, 2, 102, NULL, NULL, 'A+', 'Private'),
	(3, 'David', 'Johnson', '1992-11-30', '123-45-6791', '555-1003', 1, 1, 2, 1, 'david.johnson@email.com', 'Y', 1, NULL, 3, 105, NULL, NULL, 'B+', 'Medicare'),
	(4, 'Sarah', 'Williams', '1980-05-14', '123-45-6792', '555-1004', 2, 2, 2, 1, 'sarah.williams@email.com', 'Y', 4, NULL, 4, 103, NULL, NULL, 'AB-', 'Private'),
	(5, 'Michael', 'Brown', '1975-09-08', '123-45-6793', '555-1005', 1, 1, 2, 2, 'michael.brown@email.com', 'Y', 2, NULL, 5, 104, NULL, NULL, 'O-', 'Private'),
	(6, 'Jennifer', 'Davis', '1988-12-25', '123-45-6794', '555-1006', 2, 2, 2, 1, 'jennifer.davis@email.com', 'Y', 5, NULL, 6, 101, NULL, NULL, 'A-', 'Private'),
	(7, 'Robert', 'Miller', '1965-02-18', '123-45-6795', '555-1007', 1, 1, 2, 1, 'robert.miller@email.com', 'Y', 2, NULL, 7, 105, NULL, NULL, 'B-', 'Medicare'),
	(8, 'Lisa', 'Wilson', '1990-08-11', '123-45-6796', '555-1008', 2, 2, 1, 3, 'lisa.wilson@email.com', 'Y', 3, NULL, 8, 102, NULL, NULL, 'AB+', 'Private');
...
-- Dumping data for table med-app-db.PatientVisit: ~3 rows (approximately)
DELETE FROM `PatientVisit`;
INSERT INTO `PatientVisit` (`Visit_id`, `Appointment_id`, `Patient_id`, `Office_id`, `Date`, `Blood_pressure`, `Doctor_id`, `Nurse_id`, `Status`, `Diagnosis`, `Treatment`, `Reason_for_Visit`, `Department`, `AmountDue`, `Payment`, `TotalDue`, `CopayAmount_Due`, `TreatmentCost_Due`, `Consent_to_treatment`, `Present_illnesses`, `Temperature`, `Start_at`, `End_at`, `Insurance_policy_id_used`, `CreatedAt`, `CreatedBy`, `LastUpdated`, `UpdatedBy`) VALUES
	(1, 1001, 1, 1, '2025-01-15 09:00:00', '120/80', 1, 1, 'Completed', '["Hypertension", "Type 2 Diabetes"]', 'Continue current medications, lifestyle modifications', 'Annual physical examination', 'Internal Medicine', 150.00, 25.00, 125.00, 25.00, 125.00, 1, '["Stable condition"]', 98.6, '2024-01-15 09:00:00', '2024-01-15 09:45:00', 1, '2025-10-23 04:41:08', 'Dr. Emily Chen', '2025-10-23 04:41:08', 'Dr. Emily Chen'),
	(2, 1002, 3, 3, '2025-01-16 14:00:00', '118/76', 1, 2, 'Completed', '["Hyperlipidemia"]', 'Start statin therapy, dietary changes', 'Follow-up consultation', 'Internal Medicine', 120.00, 15.00, 105.00, 15.00, 105.00, 1, '["Elevated cholesterol levels"]', 98.4, '2024-01-16 14:00:00', '2024-01-16 14:30:00', 3, '2025-10-23 04:41:08', 'Dr. Emily Chen', '2025-10-23 04:41:08', 'Dr. Emily Chen'),
	(3, 1003, 5, 1, '2025-01-15 10:30:00', '130/85', 2, 5, 'Completed', '["Osteoarthritis"]', 'Pain management, physical therapy referral', 'Cardiology checkup', 'Cardiology', 200.00, 25.00, 175.00, 25.00, 175.00, 1, '["Joint pain in knees"]', 98.2, '2024-01-15 10:30:00', '2024-01-15 11:15:00', 5, '2025-10-23 04:41:08', 'Dr. James Rodriguez', '2025-10-23 04:41:08', 'Dr. James Rodriguez');
...
INSERT INTO `patient_insurance` (`id`, `patient_id`, `plan_id`, `member_id`, `group_id`, `effective_date`, `expiration_date`, `is_primary`, `copay`, `deductible_individ`, `deductible_family`, `coinsurance_rate_pct`) VALUES
	(1, 1, 101, 'M123456789', 'G987654', '2023-01-01', '2024-12-31', 1, 25.00, 1500.00, NULL, 20.00),
	(2, 2, 102, 'M123456790', 'G987655', '2023-03-01', '2024-12-31', 1, 20.00, 2000.00, NULL, 15.00),
	(3, 3, 105, 'M123456791', NULL, '2022-06-01', NULL, 1, 15.00, 500.00, NULL, 10.00),
	(4, 4, 103, 'M123456792', 'G987656', '2023-02-15', '2024-12-31', 1, 30.00, 1000.00, NULL, 25.00),
	(5, 5, 104, 'M123456793', 'G987657', '2023-01-01', '2024-12-31', 1, 25.00, 1500.00, NULL, 20.00),
	(6, 6, 101, 'M123456794', NULL, '2023-01-01', NULL, 1, NULL, 1500.00, NULL, NULL),
	(7, 7, 105, 'M123456795', NULL, '2022-06-01', NULL, 1, NULL, 500.00, NULL, NULL),
	(8, 8, 102, 'M123456796', NULL, '2023-03-01', NULL, 1, NULL, 2000.00, NULL, NULL);
...
INSERT INTO `Prescription` (`prescription_id`, `patient_id`, `doctor_id`, `appointment_id`, `medication_name`, `dosage`, `frequency`, `route`, `start_date`, `end_date`, `refills_allowed`, `notes`, `created_at`) VALUES
	(1, 1, 1, 1001, 'Lisinopril', '10mg', 'Once daily', 'Oral', '2025-01-15', NULL, 11, 'For hypertension control', '2025-10-23 04:41:08'),
...
-- Dumping data for table med-app-db.Referral: ~3 rows (approximately)
DELETE FROM `Referral`;
INSERT INTO `Referral` (`Referral_ID`, `Patient_ID`, `Date_of_approval`, `referring_doctor_staff_id`, `specialist_doctor_staff_id`, `Reason`, `appointment_id`, `Status`) VALUES
	(1, 5, NULL, 2, 4, 'Orthopedic consultation for knee pain', 1008, 'Approved'),
	(2, 1, '2025-10-25', 1, 7, 'Dermatology screening for skin rash', NULL, 'Pending'),
	(3, 4, '2025-10-16', 4, 2, 'Cardiology evaluation for chest pain', NULL, 'Approved');
...
-- Dumping data for table med-app-db.Staff: ~8 rows (approximately)
DELETE FROM `Staff`;
INSERT INTO `Staff` (`Staff_id`, `First_Name`, `Last_Name`, `SSN`, `Gender`, `Staff_Email`, `Work_Location`, `Staff_Role`, `Work_Schedule`, `License_Number`) VALUES
	(101, 'Jennifer', 'Taylor', '987-65-4326', 2, 'j.taylor@medconnect.com', 1, 'Nurse', 1, 'RN123456'),
	(102, 'Michael', 'Chen', '987-65-4327', 1, 'm.chen@medconnect.com', 1, 'Nurse', 2, 'RN123457'),
	(103, 'Sarah', 'Rodriguez', '987-65-4328', 2, 's.rodriguez@medconnect.com', 2, 'Nurse', 1, 'RN123458'),
	(104, 'David', 'Anderson', '987-65-4329', 1, 'd.anderson@medconnect.com', 3, 'Nurse', 3, 'RN123459'),
	(105, 'Lisa', 'Martinez', '987-65-4330', 2, 'l.martinez@medconnect.com', 4, 'Nurse', 2, 'RN123460'),
	(201, 'Amanda', 'Wilson', '987-65-4331', 2, 'a.wilson@medconnect.com', 1, 'Administrator', 1, NULL),
	(202, 'Christopher', 'Lee', '987-65-4332', 1, 'c.lee@medconnect.com', 2, 'Receptionist', 2, NULL),
	(204, 'Daniel', 'Thompson', '987-65-4334', 1, 'd.thompson@medconnect.com', 4, 'Receptionist', 4, 'RTT123456');
...
CREATE TABLE IF NOT EXISTS `user_account` (
  ...
  `role` enum('PATIENT','DOCTOR','NURSE','RECEPTIONIST','ADMIN') NOT NULL DEFAULT 'PATIENT',
...
INSERT INTO `user_account` (`user_id`, `username`, `email`, `password_hash`, `role`, `mfa_enabled`, `last_login_at`, `failed_login_count`, `is_active`, `created_at`) VALUES
	(1, 'p101', 'john.smith@email.com', 'MedApp123!', 'PATIENT', 0, NULL, 0, 1, '2025-10-22 04:54:59'),
	(2, 'd201', 'echen@medconnect.com', 'MedApp123!', 'DOCTOR', 0, NULL, 0, 1, '2025-10-22 04:54:59');
...
-- Dumping data for table med-app-db.VaccinationHistory: ~9 rows (approximately)
DELETE FROM `VaccinationHistory`;
INSERT INTO `VaccinationHistory` (`VaccinationID`, `patient_id`, `Vaccination_name`, `DateOfVaccination`, `DateForBooster`) VALUES
...
-- Dumping data for table med-app-db.WorkSchedule: ~15 rows (approximately)
DELETE FROM `WorkSchedule`;
INSERT INTO `WorkSchedule` (`Schedule_id`, `Office_id`, `Staff_id`, `Doctor_id`, `Nurse_id`, `Days`, `Start_time`, `End_time`, `Day_of_week`) VALUES
	(1, 1, 101, NULL, 1, '2024-01-15', '08:00:00', '16:00:00', 'Monday'),
	(2, 1, 102, NULL, 2, '2024-01-15', '12:00:00', '20:00:00', 'Monday'),
	(3, 1, NULL, 1, NULL, '2024-01-15', '09:00:00', '17:00:00', 'Monday'),
	(4, 2, NULL, 3, NULL, '2024-01-15', '08:30:00', '16:30:00', 'Monday'),
	(5, 1, NULL, 2, NULL, '2024-01-15', '10:00:00', '18:00:00', 'Monday'),
	(6, 1, NULL, 1, NULL, NULL, '09:00:00', '17:00:00', 'Monday'),
	(7, 2, NULL, 1, NULL, NULL, '09:00:00', '17:00:00', 'Tuesday'),
	(8, 1, NULL, 1, NULL, NULL, '09:00:00', '17:00:00', 'Wednesday'),
	(9, 2, NULL, 1, NULL, NULL, '09:00:00', '17:00:00', 'Thursday'),
	(10, 1, NULL, 1, NULL, NULL, '09:00:00', '17:00:00', 'Friday'),
	(11, 1, NULL, 2, NULL, NULL, '08:00:00', '16:00:00', 'Monday'),
	(12, 1, NULL, 2, NULL, NULL, '08:00:00', '16:00:00', 'Wednesday'),
	(13, 4, NULL, 2, NULL, NULL, '10:00:00', '18:00:00', 'Tuesday'),
	(14, 4, NULL, 2, NULL, NULL, '10:00:00', '18:00:00', 'Thursday'),
	(15, 4, NULL, 2, NULL, NULL, '09:00:00', '13:00:00', 'Friday');
