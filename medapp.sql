...
CREATE TABLE `PatientVisit` (
  ...
  KEY `fk_pv__appointment_idx` (`Appointment_id`),
  CONSTRAINT `fk_pv__appointment` FOREIGN KEY (`Appointment_id`) REFERENCES `Appointment` (`Appointment_id`),
...
-- Dump completed on 2025-10-27 21:39:59
